...
const action = new _nextcloud_files__WEBPACK_IMPORTED_MODULE_0__.FileAction({
  ...
  title: nodes => {
    ...
    return "".concat((0,_nextcloud_l10n__WEBPACK_IMPORTED_MODULE_2__.translate)('files_reminders', 'Clear reminder'), " \u2013 ").concat((0,_shared_utils_ts__WEBPACK_IMPORTED_MODULE_5__.getVerboseDateString)(dueDate));
  },
...
const action = new _nextcloud_files__WEBPACK_IMPORTED_MODULE_0__.FileAction({
  ...
  title: nodes => {
    const node = nodes.at(0);
    const dueDate = new Date(node.attributes['reminder-due-date']);
    return "".concat((0,_nextcloud_l10n__WEBPACK_IMPORTED_MODULE_1__.translate)('files_reminders', 'Reminder set'), " \u2013 ").concat((0,_shared_utils_ts__WEBPACK_IMPORTED_MODULE_4__.getVerboseDateString)(dueDate));
  },
...
const generateFileAction = option => {
  return new _nextcloud_files__WEBPACK_IMPORTED_MODULE_0__.FileAction({
    id: "set-reminder-".concat(option.dateTimePreset),
    displayName: () => "".concat(option.label, " \u2013 ").concat(option.dateString),
    title: () => "".concat(option.ariaLabel, " \u2013 ").concat(option.verboseDateString),
    // Empty svg to hide the icon
    iconSvgInline: () => '<svg></svg>',
    enabled: () => Boolean((0,_shared_utils__WEBPACK_IMPORTED_MODULE_4__.getDateTime)(option.dateTimePreset)),
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (vue__WEBPACK_IMPORTED_MODULE_11__["default"].extend({
  ...
  methods: {
    ...
    open(node) {
      ...
      this.isValid = true;
      this.opened = true;
      this.customDueDate = dueDate !== null && dueDate !== void 0 ? dueDate : (0,_shared_utils_ts__WEBPACK_IMPORTED_MODULE_8__.getInitialCustomDueDate)();
...
/******/ })()
;
//# sourceMappingURL=files_reminders-init.js.map?v=d6aee8632bcb3183165a