...
/* harmony import */ var _components_AuthTokenSection_vue__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./components/AuthTokenSection.vue */ "./apps/settings/src/components/AuthTokenSection.vue");
...
const View = vue__WEBPACK_IMPORTED_MODULE_5__["default"].extend(_components_AuthTokenSection_vue__WEBPACK_IMPORTED_MODULE_1__["default"]);
new View({
  pinia
...
const useAuthTokenStore = (0,pinia__WEBPACK_IMPORTED_MODULE_7__.defineStore)('auth-token', {
  state() {
    return {
  ...
  actions: {
    ...
    async updateToken(token) {
      const {
        data
      } = await _nextcloud_axios__WEBPACK_IMPORTED_MODULE_5__["default"].put("".concat(BASE_URL, "/").concat(token.id), token);
      return data;
    },
    /**
     * Add a new token
    ...
    async deleteToken(token) {
      ...
      try {
        await _nextcloud_axios__WEBPACK_IMPORTED_MODULE_5__["default"].delete("".concat(BASE_URL, "/").concat(token.id));
    ...
    async wipeToken(token) {
      ...
      try {
        ...
        await _nextcloud_axios__WEBPACK_IMPORTED_MODULE_5__["default"].post("".concat(BASE_URL, "/wipe/").concat(token.id));
    ...
    async renameToken(token, newName) {
      _logger__WEBPACK_IMPORTED_MODULE_6__["default"].debug("renaming app token ".concat(token.id, " from ").concat(token.name, " to '").concat(newName, "'"));
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ((0,vue__WEBPACK_IMPORTED_MODULE_9__.defineComponent)({
  ...
  computed: {
      ...
      for (const client in userAgentMap) {
        ...
        if (matches) {
          ...
          return {
            ...
            version: (_matches$ = matches[2]) !== null && _matches$ !== void 0 ? _matches$ : matches[1]
          };
        }
      }
      return null;
    ...
    tokenIcon() {
      ...
      switch ((_this$client = this.client) === null || _this$client === void 0 ? void 0 : _this$client.id) {
        case 'edge':
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ((0,vue__WEBPACK_IMPORTED_MODULE_9__.defineComponent)({
  ...
  computed: {
    ...
    appPassword() {
      var _this$token$token, _this$token;
      return (_this$token$token = (_this$token = this.token) === null || _this$token === void 0 ? void 0 : _this$token.token) !== null && _this$token$token !== void 0 ? _this$token$token : '';
    },
    loginName() {
      var _this$token$loginName, _this$token2;
      return (_this$token$loginName = (_this$token2 = this.token) === null || _this$token2 === void 0 ? void 0 : _this$token2.loginName) !== null && _this$token$loginName !== void 0 ? _this$token$loginName : '';
    },
    qrUrl() {
      const server = window.location.protocol + '//' + window.location.host + (0,_nextcloud_router__WEBPACK_IMPORTED_MODULE_2__.getRootUrl)();
      return "nc://login/user:".concat(this.loginName, "&password:").concat(this.appPassword, "&server:").concat(server);
    },
    copyPasswordLabel() {
...
/******/ })()
;
//# sourceMappingURL=settings-vue-settings-personal-security.js.map?v=b0f460f8dcd580b70fbb