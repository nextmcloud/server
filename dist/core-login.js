...
const Dialogs = {
  ...
  filepicker(title, callback) {
    ...
    const legacyCallback = (fn, type) => {
      const getPath = node => {
        const root = (node === null || node === void 0 ? void 0 : node.root) || '';
    ...
    const nodeToLegacyFile = node => {
      var _node$mtime, _node$attributes, _node$attributes2, _node$attributes3, _node$attributes4, _node$attributes5;
      return {
        id: node.fileid || null,
        path: node.path,
        mimetype: node.mime || null,
        mtime: ((_node$mtime = node.mtime) === null || _node$mtime === void 0 ? void 0 : _node$mtime.getTime()) || null,
        permissions: node.permissions,
        name: ((_node$attributes = node.attributes) === null || _node$attributes === void 0 ? void 0 : _node$attributes.displayName) || node.basename,
        etag: ((_node$attributes2 = node.attributes) === null || _node$attributes2 === void 0 ? void 0 : _node$attributes2.etag) || null,
        hasPreview: ((_node$attributes3 = node.attributes) === null || _node$attributes3 === void 0 ? void 0 : _node$attributes3.hasPreview) || null,
        mountType: ((_node$attributes4 = node.attributes) === null || _node$attributes4 === void 0 ? void 0 : _node$attributes4.mountType) || null,
        quotaAvailableBytes: ((_node$attributes5 = node.attributes) === null || _node$attributes5 === void 0 ? void 0 : _node$attributes5.quotaAvailableBytes) || null,
        icon: null,
    ...
    if (type === this.FILEPICKER_TYPE_CUSTOM) {
      ...
      builder.setButtonFactory((nodes, path) => {
        var _nodes$, _nodes$2;
        const buttons = [];
        const node = (nodes === null || nodes === void 0 || (_nodes$ = nodes[0]) === null || _nodes$ === void 0 || (_nodes$ = _nodes$.attributes) === null || _nodes$ === void 0 ? void 0 : _nodes$.displayName) || (nodes === null || nodes === void 0 || (_nodes$2 = nodes[0]) === null || _nodes$2 === void 0 ? void 0 : _nodes$2.basename);
    ...
    if (typeof (options === null || options === void 0 ? void 0 : options.filter) === 'function') {
      builder.setFilter(node => options.filter(nodeToLegacyFile(node)));
    }
    builder.allowDirectories((options === null || options === void 0 ? void 0 : options.allowDirectoryChooser) === true || (mimetype === null || mimetype === void 0 ? void 0 : mimetype.includes('httpd/unix-directory')) || false).setMultiSelect(multiselect).startAt(path).build().pick();
  },
  /**
   * Displays raw dialog
...
/* harmony import */ var _mixins_auth_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../../mixins/auth.js */ "./core/src/mixins/auth.js");
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  mixins: [_mixins_auth_js__WEBPACK_IMPORTED_MODULE_7__["default"]],
  props: {
    username: {
      type: String,
      default: ''
  ...
  computed: {
    ...
    resetFormTimeout() {
      ...
      return (0,debounce__WEBPACK_IMPORTED_MODULE_3__.debounce)(this.handleResetForm, this.loginTimeout * 1000);
    },
    isError() {
    ...
    loginText() {
      if (this.emailEnabled) {
        return (0,_nextcloud_l10n__WEBPACK_IMPORTED_MODULE_1__.translate)('core', 'Login with username or email');
      }
      return (0,_nextcloud_l10n__WEBPACK_IMPORTED_MODULE_1__.translate)('core', 'Login with username');
    }
  },
  watch: {
    /**
...
/******/ })()
;
//# sourceMappingURL=core-login.js.map?v=b61c6bddb325cdbc90e9