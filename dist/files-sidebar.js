...
/* harmony import */ var _nextcloud_paths__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @nextcloud/paths */ "./node_modules/@nextcloud/paths/dist/index.js");
...
/* harmony import */ var _logger_js__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! ../logger.js */ "./apps/files/src/logger.js");
/* provided dependency */ var console = __webpack_require__(/*! ./node_modules/console-browserify/index.js */ "./node_modules/console-browserify/index.js");
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  computed: {
    ...
    davPath() {
      ...
      return (0,_nextcloud_router__WEBPACK_IMPORTED_MODULE_6__.generateRemoteUrl)("dav/files/".concat(user).concat((0,_nextcloud_paths__WEBPACK_IMPORTED_MODULE_5__.encodePath)(this.file)));
    },
    /**
    ...
    size() {
      var _this$fileInfo;
      return (0,_nextcloud_files__WEBPACK_IMPORTED_MODULE_4__.formatFileSize)((_this$fileInfo = this.fileInfo) === null || _this$fileInfo === void 0 ? void 0 : _this$fileInfo.size);
    },
    /**
    ...
    isSystemTagsEnabled() {
      ...
      return ((_getCapabilities = (0,_nextcloud_capabilities__WEBPACK_IMPORTED_MODULE_1__.getCapabilities)()) === null || _getCapabilities === void 0 || (_getCapabilities = _getCapabilities.systemtags) === null || _getCapabilities === void 0 ? void 0 : _getCapabilities.enabled) === true;
    }
  },
  created() {
  ...
  methods: {
    ...
    getPreviewIfAny(fileInfo) {
      if (fileInfo !== null && fileInfo !== void 0 && fileInfo.hasPreview && !this.isFullScreen) {
        return (0,_nextcloud_router__WEBPACK_IMPORTED_MODULE_6__.generateUrl)("/core/preview?fileId=".concat(fileInfo.id, "&x=").concat(screen.width, "&y=").concat(screen.height, "&a=true"));
      }
     ...
     */
    getIconUrl(fileInfo) {
      const mimeType = (fileInfo === null || fileInfo === void 0 ? void 0 : fileInfo.mimetype) || 'application/octet-stream';
      if (mimeType === 'httpd/unix-directory') {
        ...
        } else if (fileInfo.shareTypes && (fileInfo.shareTypes.indexOf(_nextcloud_sharing__WEBPACK_IMPORTED_MODULE_7__.Type.SHARE_TYPE_LINK) > -1 || fileInfo.shareTypes.indexOf(_nextcloud_sharing__WEBPACK_IMPORTED_MODULE_7__.Type.SHARE_TYPE_EMAIL) > -1)) {
    ...
    setActiveTab(id) {
      ...
      this.tabs.forEach(tab => {
        try {
          ...
          _logger_js__WEBPACK_IMPORTED_MODULE_19__["default"].error('Error while setting tab active state', {
            error,
            id: tab.id,
            tab
          });
    ...
    async toggleStarred(state) {
      try {
        ...
        (0,_nextcloud_event_bus__WEBPACK_IMPORTED_MODULE_3__.emit)(state ? 'files:favorites:added' : 'files:favorites:removed', new Node({
          ...
          source: this.davPath,
          root: "/files/".concat((0,_nextcloud_auth__WEBPACK_IMPORTED_MODULE_0__.getCurrentUser)().uid),
        ...
        _logger_js__WEBPACK_IMPORTED_MODULE_19__["default"].error('Unable to change favourite state', {
          error
        });
      }
    },
...
/******/ })()
;
//# sourceMappingURL=files-sidebar.js.map?v=49af42723d189eac6820