...
function renderDeclarativeSettingsSections(forms) {
  ...
  for (const form of forms) {
    const el = "#".concat(form.app, "_").concat(form.id);
...
var render = function render() {
  ...
  return _c("NcSettingsSection", {
    ...
    return _c("div", {
      ...
      staticClass: "hint"
    }, [_vm._v(_vm._s(_vm.t(_vm.formApp, formField.description)))])] : _vm._e(), _vm._v(" "), formField.type === "select" ? [_c("label", {
      attrs: {
      ...
      staticClass: "hint"
    }, [_vm._v(_vm._s(_vm.t(_vm.formApp, formField.description)))])] : _vm._e(), _vm._v(" "), formField.type === "multi-select" ? [_c("label", {
      attrs: {
        for: formField.id + "_field"
      }
    }, [_vm._v(_vm._s(_vm.t(_vm.formApp, formField.title)))]), _vm._v(" "), _c("div", {
      ...
      staticClass: "hint"
    }, [_vm._v(_vm._s(_vm.t(_vm.formApp, formField.description)))])] : _vm._e(), _vm._v(" "), formField.type === "checkbox" ? [_c("label", {
      attrs: {
        for: formField.id + "_field"
      }
    }, [_vm._v(_vm._s(_vm.t(_vm.formApp, formField.title)))]), _vm._v(" "), _c("NcCheckboxRadioSwitch", {
      attrs: {
        id: formField.id + "_field",
      ...
      staticClass: "hint"
    }, [_vm._v(_vm._s(_vm.t(_vm.formApp, formField.description)))])] : _vm._e(), _vm._v(" "), formField.type === "multi-checkbox" ? [_c("label", {
      attrs: {
        for: formField.id + "_field"
      }
      ...
      staticClass: "hint"
    }, [_vm._v(_vm._s(_vm.t(_vm.formApp, formField.description)))])] : _vm._e(), _vm._v(" "), formField.type === "radio" ? [_c("label", {
      attrs: {
        for: formField.id + "_field"
      }
    }, [_vm._v(_vm._s(_vm.t(_vm.formApp, formField.title)))]), _vm._v(" "), _vm._l(formField.options, function (option) {
      ...
      staticClass: "hint"
    }, [_vm._v(_vm._s(_vm.t(_vm.formApp, formField.description)))])] : _vm._e()], 2);
  }), 0);
};
var staticRenderFns = [];
...
/******/ })()
;
//# sourceMappingURL=settings-declarative-settings-forms.js.map?v=580a90a774f87780bc3d