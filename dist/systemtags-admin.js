...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (vue__WEBPACK_IMPORTED_MODULE_9__["default"].extend({
  ...
  computed: {
    ...
    isUpdateDisabled() {
      var _this$selectedTag, _this$selectedTag2, _this$selectedTag3;
      return this.tagName === '' || ((_this$selectedTag = this.selectedTag) === null || _this$selectedTag === void 0 ? void 0 : _this$selectedTag.displayName) === this.tagName && getTagLevel((_this$selectedTag2 = this.selectedTag) === null || _this$selectedTag2 === void 0 ? void 0 : _this$selectedTag2.userVisible, (_this$selectedTag3 = this.selectedTag) === null || _this$selectedTag3 === void 0 ? void 0 : _this$selectedTag3.userAssignable) === this.tagLevel;
    },
    isResetDisabled() {
      if (this.isCreating) {
  ...
  methods: {
    ...
    async update() {
      ...
      try {
        ...
        (_this$$refs$tagNameIn = this.$refs.tagNameInput) === null || _this$$refs$tagNameIn === void 0 || _this$$refs$tagNameIn.focus();
      } catch (error) {
    ...
    reset() {
      var _this$$refs$tagNameIn2;
      this.selectedTag = null;
      this.errorMessage = '';
      this.tagName = '';
      this.tagLevel = TagLevel.Public;
      (_this$$refs$tagNameIn2 = this.$refs.tagNameInput) === null || _this$$refs$tagNameIn2 === void 0 || _this$$refs$tagNameIn2.focus();
    }
  }
}));
...
/******/ })()
;
//# sourceMappingURL=systemtags-admin.js.map?v=d387a9a7aaf580d74d13