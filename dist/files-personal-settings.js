  ...
  methods: {
    start() {
      ...
      picker.pick().then(dir => dir === '' ? '/' : dir).then(dir => {
        ...
        (0,_nextcloud_dialogs__WEBPACK_IMPORTED_MODULE_3__.showError)(this.directoryPickerError);
      });
    },
    ...
    submit() {
      ...
      _nextcloud_axios__WEBPACK_IMPORTED_MODULE_0__["default"].post(url, data).then(resp => resp.data).then(data => {
        ...
        (0,_nextcloud_dialogs__WEBPACK_IMPORTED_MODULE_3__.showError)(this.submitError);
      });
    }
  }
});
...
/******/ })()
;
//# sourceMappingURL=files-personal-settings.js.map?v=57f7fc79cba47a1323c1