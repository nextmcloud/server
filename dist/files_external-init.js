...
Navigation.register(new _nextcloud_files__WEBPACK_IMPORTED_MODULE_2__.View({
  ...
  columns: [new _nextcloud_files__WEBPACK_IMPORTED_MODULE_2__.Column({
    ...
    render(node) {
      var _node$attributes;
      const backend = ((_node$attributes = node.attributes) === null || _node$attributes === void 0 ? void 0 : _node$attributes.backend) || (0,_nextcloud_l10n__WEBPACK_IMPORTED_MODULE_1__.translate)('files_external', 'Unknown');
      const span = document.createElement('span');
...
/******/ })()
;
//# sourceMappingURL=files_external-init.js.map?v=08fc82a29d25517f1cfc