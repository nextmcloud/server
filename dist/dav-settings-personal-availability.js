...
const getClient = lodash_fp_memoize_js__WEBPACK_IMPORTED_MODULE_1___default()(service => {
  // init webdav client
  const remote = (0,_nextcloud_router__WEBPACK_IMPORTED_MODULE_2__.generateRemoteUrl)("dav/".concat(service, "/").concat((0,_nextcloud_auth__WEBPACK_IMPORTED_MODULE_3__.getCurrentUser)().uid));
...
async function findScheduleInboxAvailability() {
  ...
  const xml = await (0,webdav__WEBPACK_IMPORTED_MODULE_2__.parseXML)(await response.text());
  if (!xml) {
    return undefined;
  }
  const availability = xml === null || xml === void 0 || (_xml$multistatus = xml.multistatus) === null || _xml$multistatus === void 0 || (_xml$multistatus = _xml$multistatus.response[0]) === null || _xml$multistatus === void 0 || (_xml$multistatus = _xml$multistatus.propstat) === null || _xml$multistatus === void 0 ? void 0 : _xml$multistatus.prop['calendar-availability'];
  if (!availability) {
    return undefined;
  }
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  computed: {
     ...
     */
    valid() {
      var _this$firstDay, _this$lastDay;
      // Translate the two date objects to midnight for an accurate comparison
      const firstDay = new Date((_this$firstDay = this.firstDay) === null || _this$firstDay === void 0 ? void 0 : _this$firstDay.getTime());
      const lastDay = new Date((_this$lastDay = this.lastDay) === null || _this$lastDay === void 0 ? void 0 : _this$lastDay.getTime());
      firstDay === null || firstDay === void 0 || firstDay.setHours(0, 0, 0, 0);
      lastDay === null || lastDay === void 0 || lastDay.setHours(0, 0, 0, 0);
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  data() {
    ...
    const defaultTimezoneId = (_Intl$DateTimeFormat$ = (_Intl$DateTimeFormat = new Intl.DateTimeFormat()) === null || _Intl$DateTimeFormat === void 0 || (_Intl$DateTimeFormat = _Intl$DateTimeFormat.resolvedOptions()) === null || _Intl$DateTimeFormat === void 0 ? void 0 : _Intl$DateTimeFormat.timeZone) !== null && _Intl$DateTimeFormat$ !== void 0 ? _Intl$DateTimeFormat$ : 'UTC';
    return {
      loading: true,
      saving: false,
  ...
  computed: {
    timeZonePickerId() {
      return "tz-".concat((Math.random() + 1).toString(36).substring(7));
    }
  },
  async mounted() {
    try {
...
var render = function render() {
  ...
  return _c("div", [_c("div", {
    ...
    attrs: {
      for: "vs".concat(_vm.timeZonePickerId, "__combobox")
    }
...
/***/ "./node_modules/css-loader/dist/cjs.js!./node_modules/@nextcloud/calendar-availability-vue/dist/assets/index-1OlNbSWJ.css":
/*!********************************************************************************************************************************!*\
  !*** ./node_modules/css-loader/dist/cjs.js!./node_modules/@nextcloud/calendar-availability-vue/dist/assets/index-1OlNbSWJ.css ***!
  \********************************************************************************************************************************/
...
/***/ "./node_modules/@nextcloud/calendar-availability-vue/dist/assets/index-1OlNbSWJ.css":
/*!******************************************************************************************!*\
  !*** ./node_modules/@nextcloud/calendar-availability-vue/dist/assets/index-1OlNbSWJ.css ***!
  \******************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _css_loader_dist_cjs_js_index_1OlNbSWJ_css__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! !!../../../../css-loader/dist/cjs.js!./index-1OlNbSWJ.css */ "./node_modules/css-loader/dist/cjs.js!./node_modules/@nextcloud/calendar-availability-vue/dist/assets/index-1OlNbSWJ.css");
...
var update = _style_loader_dist_runtime_injectStylesIntoStyleTag_js__WEBPACK_IMPORTED_MODULE_0___default()(_css_loader_dist_cjs_js_index_1OlNbSWJ_css__WEBPACK_IMPORTED_MODULE_6__["default"], options);




       /* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (_css_loader_dist_cjs_js_index_1OlNbSWJ_css__WEBPACK_IMPORTED_MODULE_6__["default"] && _css_loader_dist_cjs_js_index_1OlNbSWJ_css__WEBPACK_IMPORTED_MODULE_6__["default"].locals ? _css_loader_dist_cjs_js_index_1OlNbSWJ_css__WEBPACK_IMPORTED_MODULE_6__["default"].locals : undefined);
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   CalendarAvailability: () => (/* binding */ U),
/* harmony export */   getEmptySlots: () => (/* binding */ W),
/* harmony export */   slotsToVavailability: () => (/* binding */ B),
/* harmony export */   vavailabilityToSlots: () => (/* binding */ H)
/* harmony export */ });
/* harmony import */ var _assets_index_1OlNbSWJ_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./assets/index-1OlNbSWJ.css */ "./node_modules/@nextcloud/calendar-availability-vue/dist/assets/index-1OlNbSWJ.css");
...
/* harmony import */ var ical_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ical.js */ "./node_modules/ical.js/build/ical.js");
...
const A = {
  ...
  methods: {
    ...
    slotsToInternalData() {
      ...
      return (0,_nextcloud_l10n__WEBPACK_IMPORTED_MODULE_5__.getFirstDay)() === 1 ? [...n, t] : [t, ...n];
    },
    internalDataToSlots() {
      const n = {};
 ...
 * along with this program.  If not, see <http://www.gnu.org/licenses/>.
 */
const w = (0,_nextcloud_logger__WEBPACK_IMPORTED_MODULE_8__.getLoggerBuilder)().detectUser().setApp("@nextcloud/calendar-availability-vue").build();
function W() {
  return {
    MO: [],
    TU: [],
...
function H(n) {
  const t = (0,ical_js__WEBPACK_IMPORTED_MODULE_7__.parse)(n), e = new ical_js__WEBPACK_IMPORTED_MODULE_7__.Component(t), s = e.getFirstSubcomponent("vavailability");
  let o;
...
function B(n, t) {
  ...
  const s = (0,icalzone__WEBPACK_IMPORTED_MODULE_6__.getZoneString)(t);
  if (s) {
  ...
  return Object.keys(u).map((i) => {
    ...
    return d.addPropertyWithValue("dtstart", ICAL.Time.fromJSDate(new Date(a * 1e3), !1)).setParameter("tzid", t), d.addPropertyWithValue("dtend", ICAL.Time.fromJSDate(new Date(l * 1e3), !1)).setParameter("tzid", t), d.addPropertyWithValue("uid", (0,uuid__WEBPACK_IMPORTED_MODULE_9__["default"])()), d.addPropertyWithValue("rrule", {
      freq: "WEEKLY",
      byday: p
    }), d;
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* reexport safe */ _chunks_NcTimezonePicker_CH1lkCMF_mjs__WEBPACK_IMPORTED_MODULE_0__.N)
/* harmony export */ });
/* harmony import */ var _chunks_NcTimezonePicker_CH1lkCMF_mjs__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../chunks/NcTimezonePicker-CH1lkCMF.mjs */ "./node_modules/@nextcloud/vue/dist/chunks/NcTimezonePicker-CH1lkCMF.mjs");
...
/******/ })()
;
//# sourceMappingURL=dav-settings-personal-availability.js.map?v=fae5ef404fef2a7dabdb