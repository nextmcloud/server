  ...
  methods: {
    ...
    mapShareRequestToShareObject(shareRequestObject) {
      ...
      const share = {
        ...
        permissions: (_shareRequestObject$p = shareRequestObject.permissions) !== null && _shareRequestObject$p !== void 0 ? _shareRequestObject$p : new _services_ConfigService_js__WEBPACK_IMPORTED_MODULE_1__["default"]().defaultPermissions,
        expiration: ''
      };
...
/* harmony import */ var _nextcloud_logger__WEBPACK_IMPORTED_MODULE_26__ = __webpack_require__(/*! @nextcloud/logger */ "./node_modules/@nextcloud/logger/dist/index.js");
/* provided dependency */ var console = __webpack_require__(/*! ./node_modules/console-browserify/index.js */ "./node_modules/console-browserify/index.js");
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  data() {
    return {
      ...
      logger: (0,_nextcloud_logger__WEBPACK_IMPORTED_MODULE_26__.getLoggerBuilder)().setApp('files_sharing').detectUser().build(),
  ...
  computed: {
    ...
    isPasswordProtected: {
      ...
      async set(enabled) {
        ...
        vue__WEBPACK_IMPORTED_MODULE_27__["default"].set(this.share, 'password', enabled ? await (0,_utils_GeneratePassword_js__WEBPACK_IMPORTED_MODULE_22__["default"])() : '');
        vue__WEBPACK_IMPORTED_MODULE_27__["default"].set(this.share, 'newPassword', this.share.password);
      }
    },
      ...
      if (this.sharePolicyHasRequiredProperties && this.requiredPropertiesMissing) {
        ...
        if (this.share && !this.share.id) {
          ...
          if (this.checkShare(this.share)) {
            ...
            this.open = true;
            (0,_nextcloud_dialogs__WEBPACK_IMPORTED_MODULE_1__.showError)(t('files_sharing', 'Error, please enter proper password and/or expiration date'));
            return false;
          }
        }
        const share = new _models_Share_js__WEBPACK_IMPORTED_MODULE_23__["default"](shareDefaults);
...
//# sourceMappingURL=apps_files_sharing_src_views_SharingTab_vue-data_image_svg_xml_3csvg_20xmlns_27http_www_w3_or-753dbe-apps_files_sharing_src_views_SharingTab_vue-data_image_svg_xml_3csvg_20xmlns_27http_www_w3_or-753dbe.js.map?v=66d1c1b063cbb9a8be4f